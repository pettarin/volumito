...
class MusicBrainzEntityReference:
...
@dataclass(frozen=True)
class Album(MusicBrainzEntityReference):
    """An album reference, by title (free text) or by MBID."""


@dataclass(frozen=True)
class Artist(MusicBrainzEntityReference):
    """An artist reference, by name (free text) or by MBID."""


@dataclass(frozen=True)
class Label(MusicBrainzEntityReference):
    """A record label reference, by name (free text) or by MBID."""


@dataclass(frozen=True)
class Place(MusicBrainzEntityReference):
