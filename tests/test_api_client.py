...
WEBSOCKET_METHODS = [
    ...
    ("add_radio_favourite", ("uri", "title", "albumart"), {}, FAVOURITE_OPERATION),
    ...
    ("remove_radio_favourite", ("uri",), {}, FAVOURITE_OPERATION),
    ...
    ("set_automatic_updates", (True, 3, 6), {}, UPDATE_OPERATION),
