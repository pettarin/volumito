...
Like the technical community as a whole,
the Volumito team and community is made up of
a mixture of professionals and volunteers from all over the world,
working on every aspect of the mission ---
...
This code applies equally to founders, mentors
...
a guide to make it easier to enrich all of us
and the technical communities in which we participate.

This code of conduct applies to all spaces managed by the Volumito project.
This includes IRC, the mailing lists, the issue tracker, events,
and any other forums created by the project team
which the community uses for communication.
In addition, violations of this code outside these spaces
...
For more details please see our ground rules below.

- **Be friendly and patient.**
- **Be welcoming.**
  We strive to be a community that welcomes and supports people
  of all backgrounds and identities.
  This includes, but is not limited to members of
...
- **Be considerate.**
  Your work will be used by other people,
  and you in turn will depend on the work of others.
  ...
  Remember that we're a world-wide community,
...
- **Be respectful.**
  ...
  for poor behavior and poor manners.
  ...
  Members of the Volumito community should be respectful
  when dealing with other members as well as with people
  outside the Volumito community.
- **Be careful in the words that you choose.**
  We are a community of professionals,
  and we conduct ourselves professionally.
  Be kind to others.
...
- **When we disagree, try to understand why.**
  ...
  and Volumito is no exception.
  It is important that we resolve disagreements and differing views constructively.
  Remember that we're different.
  The strength of Volumito comes from its varied community,
...
document.
If that doesn't answer your questions, feel free to
[contact us](mailto:volumito@albertopettarin.it).
